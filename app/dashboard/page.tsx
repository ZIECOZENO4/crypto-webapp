...
export default function Dashboard() {
  ...
  <div className= ' leading-9 pl-4 pt-7 md:flex justify-center'>
      ...
      <div className='flex justify-center pt-36  md:pt-20 md:mt-20 md:gap-32'>
        <button className=' bg-green-600 hover:bg-black  font-light p-2 rounded-3xl mb-7 md:mb-8  md:flex justify-center md:font-bold md:p-4 '><Link href={`/signup`} className='text-black hover:text-amber-50 '>let&apos;s get started</Link></button>
